...
public class DbService {
    ...
    private static Connection createConn(String dbName) throws SQLException {
     ...
     * @throws SQLException
     */
    public static Integer insertIntoDatabase(String query, List<String> params, String dbName) throws SQLException {

        try(Connection conn = createConn(dbName)){
    ...
    public static List<String[]> getData(String query, List<String> params, String dbName) throws SQLException{
    ...
    public static int executeQuery(String query, List<String> params, String dbName)
            throws SQLException{
        try(Connection conn = createConn(dbName)) {
            PreparedStatement st = getPreparedStatement(query, params, conn);
